...
class Designer(DesignerIO, DesignerCriteria, DesignerVisualization, DesignerApportionment, DesignerEstimability, DesignerEstimation, DesignerSensitivity, DesignerCandidates):
    """
